...
ConvLayer::ConvLayer(int batch, int in_channels, int in_height, int in_width,
...
void ConvLayer::forward(float* d_input) {
...
void ConvLayer::backwardData(float* d_input, float* d_output_grad) {
    float alpha = 1.0f, beta = 0.0f;
...
void ConvLayer::backwardFilter(float* d_input, float* d_output_grad) {
    float alpha = 1.0f, beta = 0.0f;
...
void ConvLayer::backwardBias(float* d_output_grad) {
    float alpha = 1.0f, beta = 0.0f;
